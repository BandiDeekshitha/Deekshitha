...
#     st.title('Stock Trend Prediction - SHORT TERM PREDICTION')
...
def app():
    ...
    st.title('SHORT TERM PREDICTION')

    # Load the S&P 500 companies symbols
    ...
    # Use the appropriate column name for the select box
